...
module.exports = {
  ...
  // protectedRoutes: ['/🌞 Private folder/u-need-a-password', '/🥟 Some test files/Protected route', '/Cricket'],
  protectedRoutes: ['/Cricket'],
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/ExtremeMemes',
    },
  ],
  ...
  datetimeFormat: 'MMMM D, YYYY hh:mm:ss A',
}
